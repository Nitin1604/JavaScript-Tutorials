...
let reg = /Nitin/; // This is a regular expression literal in js
reg = /Nitin/g; // g means global
// reg = /Nitin/i; // i means case insensitive

console.log(reg);
console.log(reg.source); // whetever is written inside the regular expression "/Nitin/" will print to the console
// Regular Expression: "/Nitin/" | Nitin is the output for reg.source and here reg is /Nitin/

let s = "This is great code with Nitin and also Nitin Coder";
